...
use crate::model::{DialogMessageRequest, MessageBoxResult};
...
lazy_static! {
    ...
    static ref RESULT_MAP: RwLock<HashMap<usize, MessageBoxResult>> = RwLock::new(HashMap::new());
}
...
pub fn insert_result(key: usize, result: MessageBoxResult) {
...
pub fn get_result(key: usize) -> Option<MessageBoxResult> {
