use crate::backends::egui_core::render::raster::math::vec4::{Vec4, vec4};
...
/// Monomorphises `$body` for the best SIMD implementation available at runtime.
macro_rules! dispatch_simd_impl {
    (|$simd_impl:ident| $body:expr) => {
        $crate::backends::egui_core::render::raster::color::dispatch_simd_impl!($crate::backends::egui_core::render::raster::color::AvailableImpl::default(), |$simd_impl| $body)
    };
    ($available_impl:expr, |$simd_impl:ident| $body:expr) => {
        match $available_impl {
            $crate::backends::egui_core::render::raster::color::AvailableImpl::Generic(i) => {
                i.dispatch(|$simd_impl: $crate::backends::egui_core::render::raster::color::GenericImpl| $body)
            }
            #[cfg(target_arch = "x86_64")]
            $crate::backends::egui_core::render::raster::color::AvailableImpl::Sse41(i) => {
                i.dispatch(|$simd_impl: $crate::backends::egui_core::render::raster::color::sse41::Sse41Impl| $body)
            }
            #[cfg(target_arch = "x86_64")]
            $crate::backends::egui_core::render::raster::color::AvailableImpl::Avx2(i) => {
                i.dispatch(|$simd_impl: $crate::backends::egui_core::render::raster::color::avx2::Avx2Impl| $body)
            }
            #[cfg(target_arch = "aarch64")]
            $crate::backends::egui_core::render::raster::color::AvailableImpl::Neon(i) => {
                i.dispatch(|$simd_impl: $crate::backends::egui_core::render::raster::color::neon::NeonImpl| $body)
            }
        }
    };
}
pub(crate) use dispatch_simd_impl;
