...
use crate::backends::egui_core::render::raster::HashMap;
...
pub fn draw_egui_mesh<const SUBPIX_BITS: i32>(
    ...
    crate::backends::egui_core::render::raster::color::dispatch_simd_impl!(simd_impl, |simd_impl| draw_egui_mesh_impl::<SUBPIX_BITS>(
        simd_impl,
        textures,
        buffer,
        clip_rect,
